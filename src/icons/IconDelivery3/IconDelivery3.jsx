...
export const IconDelivery3 = ({ color = "#FAFAFA", className }) => {
  return (
    <svg
      className={`icon-delivery-3 ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
    ...
    >
      <g className="g" clipPath="url(#clip0_120_1374)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_120_1374">
