...
export const CategoryCellphone = ({ className }) => {
  return (
    <svg
      className={`category-cellphone ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      <g className="g" clipPath="url(#clip0_921_868)">
        <path
          className="path"
        ...
        <path
          ...
          strokeWidth="2.5"
        />
        <line className="line-7" stroke="black" strokeWidth="2" x1="15.1667" x2="40.8333" y1="39.8334" y2="39.8334" />
      </g>
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_921_868">
