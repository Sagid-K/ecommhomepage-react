...
export const IconCustomerService1 = ({ color = "black", className }) => {
  return (
    <svg
      className={`icon-customer-service-1 ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
    ...
    >
      <g className="g" clipPath="url(#clip0_921_352)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_921_352">
