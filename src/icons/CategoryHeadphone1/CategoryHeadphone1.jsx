...
export const CategoryHeadphone1 = ({ color = "black", className }) => {
  return (
    <svg
      className={`category-headphone-1 ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      <g className="g" clipPath="url(#clip0_921_644)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_921_644">
